...
#ifndef ANYFIMESH_CORE_MESHUCB_H
#define ANYFIMESH_CORE_MESHUCB_H

#include "MeshControlBlock.h"


class MeshUCB : public MeshControlBlock {
public:
    MeshUCB();
    explicit MeshUCB(ControlBlockKey key);
...
#endif //ANYFIMESH_CORE_MESHUCB_H
