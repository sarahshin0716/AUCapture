...
extern void enet_log(ENetHost * host, const char* text);
extern void enet_log_dump(ENetHost * host, const char* tag, const char* buf, int len);
...
enet_protocol_dispatch_incoming_commands (ENetHost * host, ENetEvent * event)
{
    while (! enet_list_empty (& host -> dispatchQueue))
    {
       ...
       case ENET_PEER_STATE_CONNECTION_SUCCEEDED:
           enet_log(host, "ENET_PEER_STATE_CONNECTION_PENDING OR ENET_PEER_STATE_CONNECTION_SUCCEEDED");
       ...
       case ENET_PEER_STATE_ZOMBIE:
           enet_log(host, "ENET_PEER_STATE_ZOMBIE");
       ...
       case ENET_PEER_STATE_CONNECTED:
           enet_log(host, "ENET_PEER_STATE_CONNECTED");
...
//           enet_log(host, "ENET_PROTOCOL_COMMAND_ACKNOWLEDGE");
          if (enet_protocol_handle_acknowledge (host, event, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_CONNECT:
//           enet_log(host, "ENET_PROTOCOL_COMMAND_CONNECT");
          if (peer != NULL)
            goto commandError;
       ...
       case ENET_PROTOCOL_COMMAND_VERIFY_CONNECT:
           enet_log(host, "ENET_PROTOCOL_COMMAND_VERIFY_CONNECT");
          if (enet_protocol_handle_verify_connect (host, event, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_DISCONNECT:
           enet_log(host, "ENET_PROTOCOL_COMMAND_DISCONNECT");
          if (enet_protocol_handle_disconnect (host, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_PING:
           enet_log(host, "ENET_PROTOCOL_COMMAND_PING");
          if (enet_protocol_handle_ping (host, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_SEND_RELIABLE:
//           enet_log(host, "ENET_PROTOCOL_COMMAND_SEND_RELIABLE");
          if (enet_protocol_handle_send_reliable (host, peer, command, & currentData))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE:
           enet_log(host, "ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE");
          if (enet_protocol_handle_send_unreliable (host, peer, command, & currentData))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_SEND_UNSEQUENCED:
           enet_log(host, "ENET_PROTOCOL_COMMAND_SEND_UNSEQUENCED");
          if (enet_protocol_handle_send_unsequenced (host, peer, command, & currentData))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_SEND_FRAGMENT:
           enet_log(host, "ENET_PROTOCOL_COMMAND_SEND_FRAGMENT");
          if (enet_protocol_handle_send_fragment (host, peer, command, & currentData))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_BANDWIDTH_LIMIT:
           enet_log(host, "ENET_PROTOCOL_COMMAND_BANDWIDTH_LIMIT");
          if (enet_protocol_handle_bandwidth_limit (host, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_THROTTLE_CONFIGURE:
           enet_log(host, "ENET_PROTOCOL_COMMAND_THROTTLE_CONFIGURE");
          if (enet_protocol_handle_throttle_configure (host, peer, command))
            goto commandError;
          break;

       case ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE_FRAGMENT:
           enet_log(host, "ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE_FRAGMENT");
...
//            enet_peer_ping (currentPeer);
        ...
        for(i = 0; i < host -> bufferCount; i++) {
            enet_log_dump(host, "enet_protocol_send_outgoing_commands", host->buffers[i].data, host->buffers[i].dataLength);
        }
